...
function Login() {
  ...
  // Password strength checker must be defined before use
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    ...
    try {
      console.log("Sending Google credential to backend...",credentialResponse);
        ...
        <div className="relative w-full max-w-md">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-blue-100 p-8 transform transition-all duration-500 hover:shadow-3xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className={`w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 flex items-center justify-center ${
